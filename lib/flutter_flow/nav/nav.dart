        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'cards',
              path: 'cards',
              builder: (context, params) => CardsWidget(),
            ),
            FFRoute(
              name: 'Store',
              path: 'store',
            ...
            FFRoute(
              name: 'Perevod',
              path: 'perevod',
              builder: (context, params) => PerevodWidget(),
            ),
            FFRoute(
              name: 'HM',
              path: 'hm',
              ...
              builder: (context, params) => HmWidget(
            ...
            FFRoute(
              ...
              builder: (context, params) => LCWaikikiWidget(
                mealRef: params.getParam(
                  'mealRef',
                  ParamType.Document,
                ),
            ...
            FFRoute(
              ...
              builder: (context, params) => StarbucksWidget(
                mealRef: params.getParam(
                  'mealRef',
                  ParamType.Document,
                ),
